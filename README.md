...
1. r01_map_pangenome_Fig1a.R
   R script to generate map showcasing the distribution of isolates used in the pangenome study of _ _M. acridum_ _. The data required to run this script is:
   d01a_acridum_map_pg_metadata.xlsx

2. r02_table_formattable_Fig1b.R
   R script to generate table showcasing details of genome assemblies and other relevant genome information. The data required to run this script is:
